...
for chr in chrom_list:
    ...
    ##########################################################
    #het_tenx = het_file_folder + "/" + het_file_tenx_tumor_EA + chr + ".dat"
    #ofile_het_tenx = het_file_folder + "/" + output_het_file_tenx_tumor_EA + chr + ".dat"
    het_tenx = het_file_folder + "/" + het_file_tenx_EA + chr + ".dat"
    ofile_het_tenx = het_file_folder + "/" + output_het_file_tenx_EA + chr + ".dat"
