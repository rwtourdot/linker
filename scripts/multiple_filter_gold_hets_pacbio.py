...
het_file_pacbio = "filtered_coverage_june21_pacbio_normal_"
het_file_pacbio_tumor = "filtered_coverage_june21_pacbio_tumor_"
output_het_file_pacbio = "gold_" + het_file_pacbio
output_het_file_pacbio_tumor = "gold_" + het_file_pacbio_tumor
...
for chr in chrom_list:
    ...
    ##########################################################
    het_pacbio = het_file_folder + "/" + het_file_pacbio_tumor + chr + ".dat"
    ofile_het_pacbio = het_file_folder + "/" + output_het_file_pacbio_tumor + chr + ".dat"
    #het_pacbio = het_file_folder + "/" + het_file_pacbio + chr + ".dat"
    #ofile_het_pacbio = het_file_folder + "/" + output_het_file_pacbio + chr + ".dat"
    filter_het_union(het_pacbio,chr,union_chr_dict[chr],ofile_het_pacbio)
...
#het_file_tenx_EA = "filtered_coverage_june18_normal_EA_tenx_"
#het_file_tenx_tumor_EA = "filtered_coverage_june18_tumor_EA_tenx_"
#output_het_file_tenx_EA = "gold_" + het_file_tenx_EA
#output_het_file_tenx_tumor_EA = "gold_" + het_file_tenx_tumor_EA
