...
input_vcf_file="./vcf_data/HG002_GRCh38_GIAB_v.3.3.2_highconf_triophased.rmcent.vcf"
input_bam_file="/czlab/Data/HG_Ashkenazim_Trio/HG002_NA24385_Son/Nanopore/ultra-long-ont_GRCh38_reheader.bam"
