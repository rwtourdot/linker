...
binsize=10000
string_id_base="may24_normal_tenx"
nohup_file_base="nohup_cn_phase_"$string_id_base
hap_file_string="hap_solution_may22_tenx"
cov_file_string="filtered_coverage_may23_normal_tenx"
#cov_file_string="filtered_coverage_may23_tumor_tenx"
...
#cov_file_string="filtered_coverage_apr18"
