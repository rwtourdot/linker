...
#input_graph_file="./output/graph_variant_oct29_RPE1_23_hic_"
#input_graph_file="./output/graph_variant_oct29_RPE1_22_hic_"
input_graph_file="./output/graph_variant_nov7_RPE1_24_hic_"
input_hap_file="./output/hap_solution_nov7_RPE1_"
string_id="nov10_RPE1_24"
