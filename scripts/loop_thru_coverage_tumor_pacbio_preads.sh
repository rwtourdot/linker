...
#input_bam_file="/czlab/Data/HCC1954_PacBio/HCC1954_PacBio.GRCh38_aligned.deduped.sorted.bam"
input_bam_file="/czlab/Data/HCC1954_PacBio/HCC1954_preads.GRCh38_plus_sponge_aligned.sorted.bam"
tech="pacbio"

string_id="june21_tumor_preads"
