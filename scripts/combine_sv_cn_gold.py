...
sv_file_intra = "./../output/sv_phased_may25_intrachromosomal.dat"
sv_file_inter = "./../output/sv_phased_may25_interchromosomal.dat"
sv_file_foldbk = "./../output/sv_phased_may25_foldback.dat"
#cn_file_string = "cn_phased_may24_tumor_tenx_"
cn_file_string = "hap_gold_solution_"
sv_output_file = "./../output/phased_sv_sites_gold.dat"
#sv_output_file = "./../output/phased_sv_sites.dat"
...
##########################################################
sv_list = [];
sv_list = load_sv_file(sv_file_inter,sv_list,"inter")
sv_list = load_sv_file(sv_file_intra,sv_list,"intra")
sv_list = load_sv_file(sv_file_foldbk,sv_list,"fldbk")
...
for sv in sv_list:
    ...
    fout.write(str(sv.chr1)+"\t"+str(sv.pos1)+"\t"+str(sv.chr2)+"\t"+str(sv.pos2)+"\t"+str(frac1)+"\t"+str(frac2)+"\t"+str(type_sv)+"\n" )
        ...
        #print sv.chr1,sv.pos1,sv.chr2,sv.pos2,round(float(sum1)/float(end1)),round(float(sum2)/float(end2))
