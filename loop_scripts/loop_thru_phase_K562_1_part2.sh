...
CHR_list=('chr11' 'chr10' 'chr9' 'chr8' 'chr7' 'chr6' 'chr5' 'chr4' 'chr3' 'chr2' 'chr1' 'chrX')
...
do
        ...
        echo $string_id
        nohup ./linker phase -c $chr_choice -i $input_bam_file -s $input_bam_file2 -v $input_vcf_file -e $tech -n $string_id > $loop_nohup_file
done
